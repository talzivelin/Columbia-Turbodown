...
class Peabody {
	...
	function init(){
		...
		if (isset($_POST['form'])) {
			$insert = false;
			if ($_SERVER['HTTP_HOST'] == 'local:8888') {
	...
	function validate($formdata){
		...
		if (isset($required['field26998246']) && !array_key_exists('field26998246', $errors) && !preg_match("/^([0-9]{5})(-[0-9]{4})?$/i",$formdata['field26998246']) ) {
			$errors['field26998246'] = "Please verify your zipcode.";
		}
